...
@XmlRootElement(name = "VisualizzaPrescrittoRichiesta", namespace = "http://visualizzaprescrittorichiesta.xsd.dem.sanita.finanze.it")
public class VisualizzaPrescrittoRichiesta {

    @XmlElement(namespace = "http://visualizzaprescrittorichiesta.xsd.dem.sanita.finanze.it", required = true)
